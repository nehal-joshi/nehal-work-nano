...
Same experience again. Daily sessions, XP, badges, streaks, a genuine feeling of progress. The lessons were smooth. The interface was highly interactive. I was not bored. That part worked.

Then the lockdowns ended, and I stopped learning. A few months later I was at a friend's place. His son was preparing for 10th board exams. Thinking I would show off my recent algebra expertise, I asked him to bring some of his math test papers.
...
The app had taught me concepts very well. But it did not develop real problem solving skill.
...
This does not mean apps are bad and teachers are always better. That would be too easy a conclusion. The real problem is when an app optimises for engagement and mistakes it for learning.
...
But when gamification becomes the main experience, it can quietly replace curiosity with a score. I was genuinely fascinated by German because of its Sanskrit connection. The app replaced that curiosity with a streak. When the streak broke, the motivation broke with it.

That is the trap. As a learner you are not chasing mastery anymore. You are chasing rewards of activity.

---

Just before beginning my diploma at IIT Madras, a professor recommended a course called [Learning How to Learn by Dr Barbara Oakley](https://www.coursera.org/learn/learning-how-to-learn). It introduced me to spaced repetition: revisiting material and testing yourself at increasing intervals, so knowledge moves from short term exposure into long term retention.

I applied it seriously through the program. I finished with a 9.7 CGPA, among the toppers of the batch.

The same person who could not solve basic algebra in school was now handling high level statistics and machine learning algorithms in his 30s. Most of it I still remember today.
...
There is research behind this. Deci and Ryan's **Self-Determination Theory** shows how external rewards can weaken intrinsic motivation when the reward becomes the reason to continue. Robert Bjork called it **desirable difficulty**: the kind of learning that feels effortful in the moment but lasts longer.
...
If AI makes answers faster and content easier to generate, then the real challenge is to design for depth: better questions, stronger recall, improved retention, and skills that survive outside the tool. The goal should not be to make learners feel smart for a few minutes. The goal should be to help them become capable in a way that lasts.
